...
void prodSuperMELAKD(){
  ...
  const int nSamples=10;//10 for 8 TeV
  ...
  for(int ich=0;ich<3;ich++){
    ...
    string outDirName="/afs/cern.ch/user/b/bonato/work/PhysAnalysis/HZZ4L/Trees_191012_M126/"+genType+"_"+str_sqrts+"/"+chan[ich]+"/";
 ...
 SuperMELA *mySMD=new SuperMELA(126.0,chan[ich],sqrts);
