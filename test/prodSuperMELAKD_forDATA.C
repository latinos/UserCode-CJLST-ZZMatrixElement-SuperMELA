...
void prodSuperMELAKD_forDATA(){
  ...
  string fileName=dirName+files[ich]+".root";
 ...
 TTree *outTree=new TTree("data_obs","Observed Selected events");
 ...
 SuperMELA *mySMD=new SuperMELA(mH,chan[ich],sqrts);
