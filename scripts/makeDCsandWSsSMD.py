...
def parseOptions():
    ...
    parser.add_option('--spinHypCode', dest='spinCode' , type='int', default=-1, help='code for identifying the spin hypothesis test: 0=0+/0-, 1=0+/2m+, 2=0+/0h+, 3=0+/1+, 4=0+/1-, 5=0+/qq2+, 6=0+/2h+, 7=0+/2h-, 8=0+/2b+, 9=0+/gg2m+(decay), 10=0+/qq2m+(decay), 11=0+/1-(decay), 12=0+/1+(decay) (default=-1, dummy, no effect)')
