...
python makeDCsandWSsSMD.py -i SM_inputs_7TeV -a $1_7TeV -b -t templates2D_$1_7TeV --spinHyp=$2 > $1_7TeV.txt

python makeDCsandWSsSMD.py -i SM_inputs_8TeV -a $1_8TeV -b -t templates2D_$1_8TeV --spinHyp=$2 > $1_8TeV.txt
